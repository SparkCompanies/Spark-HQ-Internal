...
if (v1rx.test(h)) {
  h = h.replace(v1rx, V2);
  did.push("script (upgraded to v2.2)");
} else {
...
console.log("APPLIED ADMIN_PROGRESS_v2_2: " + did.join(", "));
