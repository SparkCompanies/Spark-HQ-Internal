...
// Sync admin mode from sessionStorage (set when PIN entered in TrainingPage)
useEffect(() => {
  const check = () => { try { setAdminMode(sessionStorage.getItem("spark-hq-admin") === "1"); } catch(e){} };
  check();
